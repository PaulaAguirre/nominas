<div class="modal fade modal-slide-in-right" aria-hidden="true"
     role="dialog" tabindex="-1" id="modal-consideracion-store-{{$persona->id}}">
    {!!Form::model ($persona, ['method'=>'PATCH','files'=>true, 'route'=>['nomina_directa_mes_curso.consideracion', $persona]])!!}
