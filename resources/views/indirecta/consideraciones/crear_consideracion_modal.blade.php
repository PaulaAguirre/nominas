<div class="modal fade modal-slide-in-right" aria-hidden="true"
     role="dialog" tabindex="-1" id="modal-consideracion-store-{{$impulsador->id}}">
    {!!Form::model ($impulsador, ['method'=>'PATCH','files'=>true, 'route'=>['consideraciones_indirecta.agregar_consideracion', $impulsador]])!!}
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-blue">Agregar Consideración: {{$impulsador->impulsador->nombre}}</h4>
            </div>
