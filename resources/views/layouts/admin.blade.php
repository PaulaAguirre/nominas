            ...
            <ul class="sidebar-menu">
                ...
                @if(auth()->user()->hasRoles(['tigo_people', 'tigo_people_admin']))
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('aprobacion_nomina_directa')}}/201912"><i class="fa fa-user-plus"></i> Aprobar Nuevos Ingresos Dir</a></li>
                            <li><a href="{{url('aprobacion_consideraciones_directa')}}/201912"><i class="fa fa-check-square"></i> Aprobar consideraciones Dir</a></li>
                            <li><a href="{{url('representantes_directa/aprobacion_estructura')}}/201912"><i class="fa fa-check-square"></i>Cambios Estructura Dir</a></li>
