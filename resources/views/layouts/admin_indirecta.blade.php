...
<div class="wrapper">
    ...
    <header class="main-header" >
        ...
        <!-- Logo -->
        <a href="/index" class="logo" style="background-color: #5d59a6">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini"><b>PN</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><i class="fa fa-home"></i><b>NÓMINA Indirecta</b></span>
        </a>

        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-static-top" role="navigation" style="background-color: #5d59a6" >
                    ...
                    <!-- User Account: style can be found in dropdown.less -->
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header" style="background-color: #5d59a6">
            ...
            <ul class="sidebar-menu">
                ...
                @if(auth()->user()->hasRoles(['tigo_people', 'tigo_people_admin']))
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('aprobacion_nomina_indirecta')}}/{{\Carbon\Carbon::now()->format ('Ym')}}"><i class="fa fa-user-plus"></i> Aprobar Nuevos Ingresos </a></li>
                            <li><a href="{{url('aprobacion_consideraciones_indirecta')}}"><i class="fa fa-check-square"></i> Aprobar consideraciones</a></li>
                            <li><a href="{{url('aprobar_inactivaciones_indirecta')}}"><i class="fa fa-check-square"></i>Aprobar Inactivaciones</a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span>Representantes (todos)</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('nomina_indirecta')}}"><i class="fa fa-list-ol"></i>Nómina Indirecta</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#"><i class="fa fa-calculator"></i> Objetivos Ind</a></li>
                    </ul>
                </li>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title text-purple">Nómina de Representantes</h3>
