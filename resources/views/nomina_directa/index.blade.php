    ...
    <div class="row">
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
            <h3>Nómina - Canal: Directa.  <span class="text-green">Mes: {{$mes_en_curso}}</span>
                ...
                @else
                    @if(\Carbon\Carbon::today() < (new Carbon\Carbon('first day of this month'))->addDay(06))
                        ...
                        @if(auth()->user()->hasRoles(['zonal', 'tigo_people']))
                            @if(in_array($persona->personaDirecta->id_zona, $zonas))
                                <tr class="text-uppercase text-sm">
                                    ...
                                    @if(auth()->user()->hasRoles(['zonal']) and (\Carbon\Carbon::today() < (new Carbon\Carbon('first day of this month'))->addDay(06)))
                                        <td>
