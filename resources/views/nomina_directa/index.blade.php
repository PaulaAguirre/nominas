        ...
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
            <h3>Nómina - Canal: Directa.
                @if(auth()->user()->hasRoles(['tigo_people_admin']))
                    <a href="ingresar_nuevo_asesor"><button class="btn btn-facebook">Ingresos Mes Actual 2020-01</button></a>
                        ...
                        @if(auth()->user()->hasRoles(['zonal', 'tigo_people']))
                            @if(in_array($persona->personaDirecta->id_zona, $zonas))
                                <tr class="text-uppercase text-sm">
                                    ...
                                    @if(auth()->user()->hasRoles(['zonal']) and (\Carbon\Carbon::today() < (new Carbon\Carbon('first day of this month'))->addDay(26)))
                                        <td>
